import{d as _,O as u,C as h,o as n,b as l,e as t,x as s,B as c,F as f,P as g,A as v,l as x,g as b}from"../modules/vue-BMF23GvP.js";import{n as y,l as N,j as m}from"../index-BbuVnu5y.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-COCKNO96.js";import"../modules/shiki-Bv_t3e9G.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j={key:0,class:"border-main mb-8"},z=_({__name:"print",setup(A){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
